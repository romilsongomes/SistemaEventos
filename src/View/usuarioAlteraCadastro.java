 ...
 * @author Romilso
 */
public class usuarioAlteraCadastro extends javax.swing.JFrame {

    /**
     * Creates new form usuarioAlteraCadastro
     */
    public usuarioAlteraCadastro() {
        initComponents();
    }
    ...
    private void botaoSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoSalvarActionPerformed
        ...
        EnderecoM e = new EnderecoM();
        String cpf1 = campoCpf.getText();
        String email1 = campoEmail.getText();
        String telefone1 = campoTelefone.getText();
        String senha1 = campoSenha.getText();
        ...
        u.alteraUsuarioM(cpf1, nome1, email1, telefone1, senha1);
        String estado1 = campoEstado.getText();
        String cidade1 = campoCidade.getText();
        String cep1 = campoCep.getText();
        String rua1 = campoRua.getText();
        String bairro1 = campoBairro.getText();
        String numero1 = campoNumero.getText();
        //cpf, estado, cidade, cep, rua, bairro, numero
        e.upadeteEndereco(estado1, cidade1, cep1, rua1, bairro1, numero1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(usuarioAlteraCadastro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        //</editor-fold>
        System.out.println("o codigo do usuario aqui eh codUsuario");
        /* Create and display the form */
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new usuarioAlteraCadastro().setVisible(true);
            }
        });
    }
